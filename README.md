...
- **Agent surface** — 109 abilities plus 15 remote twins; an MCP server with a read door (49 tools) and a write door (16), and a remote door for Claude on a phone; the site as something agents read, with the rights terms they read it under
