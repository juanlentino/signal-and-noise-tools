...
function sn_settings_seed_legacy_values() {
	...
	if ( $host === SN_LEGACY_HOST ) {
		update_option( SN_SETTINGS_OPTION, array(
			...
			'og' => array(
				'default_image_url' => home_url( '/wp-content/uploads/2026/09/cropped-jl_logo-min-300x300.webp' ) // 16.7.2: the February PNG was replaced by a WebP upload on 2026-09-19; the file is named, not read,
				'card_width'        => 1200,
				'card_height'       => 630,
			),
			'login' => array(
