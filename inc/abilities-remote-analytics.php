...
add_action( 'wp_abilities_api_init', function () {
	...
	wp_register_ability( 'signal-noise/remote-get-analytics-summary', array(
		...
		'description'         => 'Remote-scoped twin of signal-noise/get-analytics-summary. '
			...
			. 'as an estimate and not a precise ratio. PREFER `view_visit_ratio` when judging '
			. 'engagement: `pageviews_per_visitor_day` is DILUTED BY DESIGN by feed- and beacon-only '
			. 'visitor-days (a server-side feed beacon creates a visitor-day with no pageview), so it '
			. 'reads below 1.0 on a healthy site and a low value there is not a defect to investigate. '
			. 'See the admin ability\'s description for the '
