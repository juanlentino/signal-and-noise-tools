...
function sn_admin_render_uses_section() {
	...
	echo '<p class="sn-field-helper">Each card is one gear group: a label plus name/note rows (the note is optional). Rows under a blank label — or a note with no name — are refused at save. Removing every card clears the override — the page falls back to the theme\'s built-in list (it is never silently blanked).</p>';
