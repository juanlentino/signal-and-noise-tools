...
function sn_admin_flash_messages() {
	return array(
		...
		'resume_pdf_failed'         => array( 'error', 'The resume PDF could not be built. Check that uploads is writable and lib/pdf is present.' ),
		...
		'tag_fit_read'              => array( 'success', 'Jev read every note against the tags it carries: review below.' ),
		'tag_fit_failed'            => array( 'error', 'The tag-fit pass failed; the Jev meter and the connector say why.' ),
		'tag_fit_unavailable'       => array( 'error', 'Install Connector for TypeSafe Jev and add the key under Settings › Connectors.' ),
		'tag_fit_applied'           => array( 'success', 'Tags removed; the next pass re-reads the notes.' ),
		'tag_fit_nothing'           => array( 'warning', 'Nothing applied: no checked row was one Jev listed.' ),
		'tag_group_applied'         => array( 'success', 'Filed; /notes/tags reads the new groups now.' ),
		'tag_group_nothing'         => array( 'warning', 'Nothing filed: every tag already renders where you set it.' ),
		'tag_group_unavailable'     => array( 'error', 'The theme\'s tag groups are not available (Signal & Noise theme 13.4.0 or later).' ),
		...
		'zenodo_env_saved'          => array( 'success', 'Zenodo environment saved. Sandbox DOIs are test DOIs and never reach a public surface.' ),
		'zenodo_no_token'           => array( 'error', 'No Zenodo token for this environment. Add it under Connections &rsaquo; Credentials first.' ),
		'zenodo_batch_done'         => array( 'success', 'Deposited. The DOI is on the record and flows into the schema and the citation on the next paint.' ),
