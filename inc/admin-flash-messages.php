...
function sn_admin_flash_messages() {
	return array(
		...
		'tag_fit_read'              => array( 'success', 'Jev read every note against its tags: review below.' ),
		...
		'tag_fit_applied'           => array( 'success', 'Tags applied; the next pass re-reads the notes.' ),
