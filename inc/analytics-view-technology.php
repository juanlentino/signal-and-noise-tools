...
function snt_analytics_render_view_technology( $from, $to, $class, $granularity ) {
	...
	snt_analytics_render_dim_table( __( 'Browsers', 'signal-and-noise-tools' ), $brow_rows, 'No browser data in this range yet.', $brow_ser, 'browser' );
	...
	snt_analytics_render_dim_table( __( 'Operating systems', 'signal-and-noise-tools' ), $os_rows, 'No OS data in this range yet.', $os_ser, 'os' );
	...
	snt_analytics_render_dim_table( __( 'Devices', 'signal-and-noise-tools' ), $dev_rows, 'No device data in this range.', $dev_ser, 'device' );
	...
	snt_analytics_render_dim_table( __( 'Protocols', 'signal-and-noise-tools' ), $pro_rows, 'No protocol data in this range yet.', $pro_ser, 'protocol' );
	...
	snt_analytics_render_dim_table( __( 'TLS versions', 'signal-and-noise-tools' ), $tls_rows, 'No TLS data in this range yet.', $tls_ser, 'tls' );
	echo '</div>';
