...
function snt_ability_cloudflare_status( $input = null ) {
	...
	if ( ! is_array( $record ) ) {
		return array( 'state' => 'never_run', 'fetched_at' => null, 'configured' => null, 'token' => null, 'zone' => null, 'firewall' => null, 'posture' => null );
	}
