...
function sn_keyring() {
	return array(
		...
		'typesafe_api_key'      => array( 'group' => 'issued', 'label' => __( 'TypeSafe API key (Jev)', 'signal-and-noise-tools' ), 'kind' => 'secret', 'constant' => 'SN_TYPESAFE_API_KEY', 'option' => 'sn_typesafe_api_key', 'about' => __( 'From console.typesafe.ai › Settings › Keys. Jev judges typed questions about a note; it generates nothing.', 'signal-and-noise-tools' ), 'feeds' => __( 'the daily Jev pass over the notes (health check 30, the jev-notes ability)', 'signal-and-noise-tools' ), 'probe' => 'typesafe' ),
