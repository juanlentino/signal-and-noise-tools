...
function sn_keyring() {
	return array(
		...
		'betterstack_token'     => array( 'group' => 'issued', 'label' => __( 'Better Stack API token', 'signal-and-noise-tools' ), 'kind' => 'secret', 'constant' => 'SN_BETTERSTACK_API_TOKEN', 'option' => 'sn_betterstack_api_token', 'about' => __( 'Issued by Better Stack (Uptime › API tokens).', 'signal-and-noise-tools' ), 'feeds' => __( 'the Uptime tab and tile; the WAF witness', 'signal-and-noise-tools' ), 'probe' => 'betterstack' ),
		'spotify_client_id'     => array( 'group' => 'issued', 'label' => __( 'Spotify client ID', 'signal-and-noise-tools' ), 'kind' => 'id', 'constant' => 'SN_SPOTIFY_CLIENT_ID', 'option' => 'sn_spotify_client_id', 'about' => __( 'Issued by Spotify for Developers.', 'signal-and-noise-tools' ), 'feeds' => __( 'the Discography sync', 'signal-and-noise-tools' ) ),
		'spotify_client_secret' => array( 'group' => 'issued', 'label' => __( 'Spotify client secret', 'signal-and-noise-tools' ), 'kind' => 'secret', 'constant' => 'SN_SPOTIFY_CLIENT_SECRET', 'option' => 'sn_spotify_client_secret', 'about' => __( 'Issued by Spotify for Developers.', 'signal-and-noise-tools' ), 'feeds' => __( 'the Discography sync', 'signal-and-noise-tools' ), 'probe' => 'spotify' ),
		'github_token'          => array( 'group' => 'issued', 'label' => __( 'GitHub token (spend)', 'signal-and-noise-tools' ), 'kind' => 'secret', 'constant' => 'SN_SPEND_GH_TOKEN', 'option' => 'sn_spend_gh_token', 'about' => __( 'A GitHub token with billing read.', 'signal-and-noise-tools' ), 'feeds' => __( 'the Actions spend reading', 'signal-and-noise-tools' ), 'probe' => 'github' ),
		'anthropic_admin_key'   => array( 'group' => 'issued', 'label' => __( 'Anthropic admin key (spend)', 'signal-and-noise-tools' ), 'kind' => 'secret', 'constant' => 'SN_SPEND_AI_ADMIN_KEY', 'option' => 'sn_spend_ai_admin_key', 'about' => __( 'An Anthropic admin key with usage read.', 'signal-and-noise-tools' ), 'feeds' => __( 'the AI spend reading', 'signal-and-noise-tools' ) ),
