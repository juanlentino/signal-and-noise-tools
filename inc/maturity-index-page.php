...
function sn_maturity_index_items() {
	$items = array(
		...
		'machine'    => array( __( 'Machine readability', 'signal-and-noise-tools' ), __( 'How do machines read this site?', 'signal-and-noise-tools' ), __( 'A crawler manifest in the site\'s own words, machine-readable terms on every response, structured data, stamped artifacts, and a bounded agent door.', 'signal-and-noise-tools' ), 'machine-readability' ),
