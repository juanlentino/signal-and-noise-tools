...
function sn_aw_realtime() {
	...
	echo '<p class="sn-aw-foot">Last 5 min · refreshes every 30 s · <a href="' . esc_url( admin_url( 'admin.php?page=sn-monitoring&tab=monitoring&sub=analytics' ) ) . '">Open Analytics →</a></p>';
}
...
function sn_aw_footer() {
	echo '<p class="sn-aw-foot">7d · first-party · <a href="' . esc_url( admin_url( 'admin.php?page=sn-monitoring&tab=monitoring&sub=analytics' ) ) . '">Open Analytics →</a></p>';
}
