...
require_once SNT_PATH . 'inc/sn-apply-plan-changes.php';     // v13.94.0: change.type "batch" — HETEROGENEOUS changes to one post in ONE write. payload.edits batches one type; this batches a sentence_replace and two block_inserts as the single editorial act they are, so one amendment mints one ledger version instead of three.
