...
require_once __DIR__ . '/inc/cloudflare-manual-purge-settle.php';  // v13.88.0: records a manual purge's verdict from the SETTLED report, not the inline sample that raced propagation.
