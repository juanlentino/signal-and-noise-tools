...
require_once SNT_PATH . 'inc/sn-apply-executors.php';        // v10.40.0: MCP consolidation session 6b (+6c: create_draft's target resolution + mode-support entry) — target resolution, mode-support matrix, and per-change-type write dispatch, delegating to the absorbed apply impls.
