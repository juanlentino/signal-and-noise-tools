...
require_once SNT_PATH . 'inc/breached-credentials-set.php'; // v13.58.0: Mode A — set-time, blocking, FAIL-CLOSED (user_profile_update_errors + validate_password_reset; 17.2.2: + rest_dispatch_request on the users controller, the native profile window's path).
...
require_once __DIR__ . '/inc/abilities-edge-errors.php'; // 18.0.0: the 5xx rollup on its own, so a phone can read it without the perimeter.
...
require_once __DIR__ . '/inc/editorial-conventions-detect.php'; // v14.7.0: house-convention drift detector, shared by sn-validate (body) and sn-scan (editorial_conventions); reads the THEME's registry
require_once __DIR__ . '/inc/sn-scan-editorial-conventions.php'; // v14.7.0: scan_type "editorial_conventions" — own file per the two above
