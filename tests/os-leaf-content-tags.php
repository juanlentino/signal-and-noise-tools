...
$kit = kit_tags(); $classic = classic_tags();
$bytag = ledger_rows( $kit, 'Jev: by tag' );
ok( 30 === count( (array) $bytag ) && 'T1' === $bytag[0]['tag'] && 4 === $bytag[0]['touching'] && 'N40 (0.20 of 2, confidence 0.70), N41 (0.20 of 2, confidence 0.70), N42 (0.20 of 2, confidence 0.70) +1' === $bytag[0]['titles'] && false !== strpos( $kit, '<p class="snt-hint">+1 more; the list is capped, not complete.</p>' ) && 30 === substr_count( $classic, '<td>0.30</td>' ) + substr_count( $classic, '<td>0.22</td>' ) && false !== strpos( $classic, '<td>N40 (0.20 of 2, confidence 0.70), N41 (0.20 of 2, confidence 0.70), N42 (0.20 of 2, confidence 0.70) +1</td>' ) && false !== strpos( $classic, '<p class="description">+1 more; the list is capped, not complete.</p>' ), '#1573 by tag: thirty rows then +1 more, three titles then +1, the widest tag first, both surfaces' );
$GLOBALS['__options'][ SN_JEV_TAGS_OPTION ] = array( 'synced_at' => 1, 'tags' => 3, 'notes' => array(
	7 => array( 'title' => 'Untagged Note', 'attached' => array( array( 'id' => 9, 'name' => 'Empty', 'score' => 0.3, 'confidence' => 0.7 ), array( 'id' => 2, 'name' => 'Jazz', 'score' => 1.8, 'confidence' => 0.9 ) ), 'missing' => array( array( 'id' => 5, 'name' => 'Blues', 'noul' => 0.9 ) ) ),
	8 => array( 'title' => 'Shrug', 'attached' => array( array( 'id' => 9, 'name' => 'Empty', 'score' => 0.3, 'confidence' => 0.6 ) ) ),
), 'usage' => array(), 'last_error' => '' );
