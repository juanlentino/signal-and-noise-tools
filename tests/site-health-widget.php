...
// ruled on them.
ok( function_exists( 'sn_health_advisory_checks' ) && sn_health_advisory_checks() === array( 'external_links', 'link_opportunities', 'stale_posts_evergreen', 'tag_hygiene', 'jev_tags' ), 'advisory_checks (16.8.2: + jev_tags): external_links + link_opportunities + stale_posts_evergreen + tag_hygiene are the advisory-tier checks' );
