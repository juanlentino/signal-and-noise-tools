...
ok( 1 === preg_match( '/<os-section heading="Accessibility">/', $kit ) && 1 === preg_match( '/<os-section heading="Other checks">/', $kit ) && false === strpos( $kit, 'heading="Findings"' ), '#1600: each family is its own os-section (Accessibility for missing_alt, Other checks for the test keys); no Findings wrapper, so no section nests in a section' );
