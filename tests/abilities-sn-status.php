...
ok( 23 === count( $map ), 'the section map has exactly 23 entries (v14.6.1 ADDED posts_signals, the Posts tab as data; v13.92.0 ADDED cache; v13.90.0 ADDED watches, the agent reader beside the morning brief; v13.88.0 ADDED shape_stability, the first reader the shape ledger has had; v13.68.0 ADDED inbound_pass; v13.63.0 ADDED search_coverage; v13.62.0 ADDED family_drift — weave Phase 5; v13.57.0 ADDED search_performance/search_drift/search_crossexam — weave Phase 1; v13.52.0 ADDED cron_health, the model over cron_scheduled/cron_history)' );
$expected_map = array(
	...
	'posts_signals'        => 'signal-noise/posts-signals', // v14.6.1
