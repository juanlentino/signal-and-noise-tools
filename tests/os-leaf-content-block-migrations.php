...
ok( false !== strpos( $kit, 'os-arg-url="https://example.test/?q=&quot;&gt;&lt;script&gt;y&lt;/script&gt;"' ) && false === strpos( $kit, '<script>' ), 'a hostile permalink is escaped in the attribute (now the door arg)' );
