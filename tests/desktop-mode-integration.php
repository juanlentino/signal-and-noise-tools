...
ok( count( $widgets ) === 9, 'all nine widgets are registered by the end of init (NOT admin_enqueue_scripts), got ' . count( $widgets ) );
...
ok( array_keys( $widgets ) === array( 'sn-site-views', 'sn-health', 'sn-uptime', 'sn-deploy-status', 'sn-cron', 'sn-quick-actions', 'sn-rss-subscribers', 'sn-anchors', 'sn-machine-readers' ),
...
ok( count( $widgets ) === 9, 'all nine widgets register (v11.29.0 adds SN Cron), got ' . count( $widgets ) );
