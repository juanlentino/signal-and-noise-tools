...
ok( false === strpos( $kit, 'name="sn_spotify_id"' ) && false === strpos( $kit, 'name="sn_spotify_secret"' ) && false === strpos( $kit, '••••ntid' ) && false === strpos( $kit, '••••9999' ) && false !== strpos( $kit, '>Client ID</dt>' ) && false !== strpos( $kit, '>Saved</dd>' ), '15.3.1: no credential field and no masked value; the Spotify block reads the sources as facts' );
...
ok( false !== strpos( $kit, '<dt class="snt-kv__k">Last sync</dt><dd class="snt-kv__v"><os-relative-time datetime="' ) && false !== strpos( $kit, '>1 hour ago</os-relative-time></dd>' ) && false !== strpos( $kit, '<dt class="snt-kv__k">Releases cached</dt><dd class="snt-kv__v">2</dd>' ), 'the Status facts: last sync ago, releases cached' );
...
ok( false !== strpos( $kit, '>wp-config (SN_SPOTIFY_CLIENT_ID)</dd>' ) && false !== strpos( $kit, '>wp-config (SN_SPOTIFY_CLIENT_SECRET)</dd>' ) && false !== strpos( $kit, '<os-text-field type="text" value="pinned-profile" disabled>' ), 'locked: the Spotify sources name their constants; the profile shows its constant, disabled and nameless' );
