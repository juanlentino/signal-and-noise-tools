...
ok( count( $read_plugin ) === 36, 'read door carries exactly 36 plugin slugs (-> 36 in 15.2.0: keyring-status; -> 35 in v14.9.0: cloudflare-status; -> 34 in v14.6.1: posts-signals; -> 33 in v13.92.0: cache-freshness; -> 32 in v13.90.0: watches; -> 31 in v13.88.0: shape-stability; -> 30 in v13.86.0: purge-verification-log; -> 29 in v13.76.0: reader-anomalies; -> 28 in v13.68.0: inbound-pass; -> 27 in v13.63.0: search-coverage; -> 26 in v13.62.0: family-drift; -> 25 in v13.57.0: three search-console reads added; -> 22 in v13.45.0: draft-echoes added; -> 21 in v13.1.0: sn-status + sn-metrics added; -> 19 in v13.0.0 wave 2; -> 24 in v12.11.0; 23 in v11.34.0; was 28 before wave 1, plugin-namespace)' );
