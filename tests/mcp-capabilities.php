...
ok( count( $read_plugin ) === 26, 'read door carries exactly 26 plugin slugs (-> 26 in v13.62.0: family-drift; -> 25 in v13.57.0: three search-console reads added; -> 22 in v13.45.0: draft-echoes added; -> 21 in v13.1.0: sn-status + sn-metrics added; -> 19 in v13.0.0 wave 2; -> 24 in v12.11.0; 23 in v11.34.0; was 28 before wave 1, plugin-namespace)' );
