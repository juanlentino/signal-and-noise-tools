...
$want = array( 'JUAN LENTINO', 'MUSIC BUSINESS DEVELOPMENT', '(555) 010-4242', 'PROFESSIONAL EXPERIENCE', 'INDEPENDENT PRACTICE', 'CORE COMPETENCIES', 'Strategic Partnerships &amp; Deal Negotiation', 'TECHNICAL TOOLKIT', 'Provenance Over Detection' );
...
if ( '' !== $pdftotext ) {
	...
	$plain = array( 'JUAN LENTINO', '(555) 010-4242', 'PROFESSIONAL EXPERIENCE', 'workflow', 'Provenance Over Detection' );
