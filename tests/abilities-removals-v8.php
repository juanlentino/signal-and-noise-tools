...
// The 7 loaded files register exactly 17 abilities post-removal
// (system 5, cron 4, audit 3, block-migrations 3, pattern-adoption 1, dismiss 1).
t_eq( 17, count( $GLOBALS['__ab'] ), 'A.10 loaded files register exactly 17 abilities (no stray additions, no over-removal)' );
