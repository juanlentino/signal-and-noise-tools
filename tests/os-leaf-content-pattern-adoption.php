...
ok( 3 === preg_match_all( '/<dd class="snt-kv__v"><os-cluster gap="6"><os-button[^>]*data-snt-suggest="1"[^>]*>Suggest<\/os-button><os-button[^>]*data-snt-dismiss="1">Dismiss<\/os-button><\/os-cluster><\/dd>/', $kit ), 'the Suggest + Dismiss pair sits in an os-cluster inside the value cell: the cell the shared script paints its editor into' );
