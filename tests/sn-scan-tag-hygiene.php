...
ok( array( 'undescribed_tag', 'unused_tag' ) === $det_ids, 'detector registry declares undescribed_tag + unused_tag (16.9.3 took over_ceiling back out: the five notes it listed carried five fitting tags each)' );
