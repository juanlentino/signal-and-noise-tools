...
ok( '' !== $edit_row && false !== strpos( $edit_row, '<input type="hidden" name="source" value="/second">' ) && false !== strpos( $edit_row, 'name="action" value="sn_redirect_update"' ), 'the edit form posts redirect_update with the source hidden' );
ok( '' !== $delete_row && false !== strpos( $delete_row, '<os-form os-confirm-title="Delete this redirect?" os-confirm-label="Delete" class="snt-form" os-action="post" submit-label="Delete"' ) && false !== strpos( $delete_row, 'os-confirm="This redirect will stop working immediately." os-confirm-danger>' ) && false !== strpos( $delete_row, 'name="action" value="sn_redirect_delete"' ) && false !== strpos( $delete_row, '<input type="hidden" name="source" value="/second">' ), 'the delete form confirms as the classic button did (title, label, question, danger) and carries its own source' );
