...
ok(
	'<div class="postbox sn-an-postbox"><div class="postbox-header"><h2 class="hndle"><span>Refresh queue</span></h2></div><div class="inside sn-an-table-inside"><table class="widefat striped"><thead><tr><th scope="col" class="manage-column column-primary">Post</th><th scope="col" class="manage-column num">Lifetime</th><th scope="col" class="manage-column num">Per day</th><th scope="col" class="manage-column">Shape</th><th scope="col" class="manage-column">Status</th></tr></thead><tbody><tr><td class="column-primary" data-colname="Post"><a href="/x/?a=1&b=2"><strong>Cool &amp; &lt;Post&gt;</strong></a> <span class="sn-an-muted">200d</span></td><td class="num" data-colname="Lifetime">50</td><td class="num" data-colname="Per day">0.2</td><td data-colname="Shape">cooling</td><td data-colname="Status"><span class="sn-pill sn-pill--warn">Refresh</span></td></tr><tr><td class="column-primary" data-colname="Post"><a href="/y/"><strong>Evergreen One</strong></a> <span class="sn-an-muted">400d</span></td><td class="num" data-colname="Lifetime">900</td><td class="num" data-colname="Per day">2.3</td><td data-colname="Shape">sustained</td><td data-colname="Status"><span class="sn-pill sn-pill--ok">Evergreen</span></td></tr><tr><td class="column-primary" data-colname="Post"><a href="/z/"><strong>Plain One</strong></a> <span class="sn-an-muted">10d</span></td><td class="num" data-colname="Lifetime">5</td><td class="num" data-colname="Per day">0.5</td><td data-colname="Shape"><span class="sn-an-muted">&mdash;</span></td><td data-colname="Status"><span class="sn-an-muted" aria-hidden="true">&mdash;</span></td></tr></tbody></table></div></div>' === $parity,
