...
function sn_analytics_top_paths( $f, $t, $c = 'human', $l = 25 ) { return array( array( 'path' => '/a/', 'views' => 1 ) ); }
...
function sn_analytics_referrer_categories( $f, $t, $c = 'human' ) { return array( array( 'category' => 'search', 'label' => 'Search', 'views' => 4, 'visits' => 2 ) ); }
