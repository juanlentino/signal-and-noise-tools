...
| `signal-noise/jev-notes` | `manage_options` | diagnostics | — | READ-DOOR (16.3.0; the stored daily Jev pass: findings above the confidence floor, the unsure count, usage) |
